...
public class ControlPanel {
    ...
    public ControlPanel() {
        ...
        kBlueTarget = new Color(0.252, 0.473, 0.275);
        kGreenTarget = new Color(0.247, 0.541, 0.212);
        kRedTarget = new Color(0.320, 0.462, 0.218);
        kYellowTarget = new Color(0.297, 0.534, 0.168);
